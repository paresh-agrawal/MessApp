...
public class NotificationRecieverLD1 extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        final PendingIntent pendingIntent = PendingIntent.getActivity(context,80,intent_repeating,PendingIntent.FLAG_UPDATE_CURRENT);

        database = FirebaseDatabase.getInstance();
        myRef = database.getReference("menu").child("D1").child(dayOfTheWeek).child("Lunch");
