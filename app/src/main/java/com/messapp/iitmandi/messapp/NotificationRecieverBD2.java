...
public class NotificationRecieverBD2 extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        final PendingIntent pendingIntent = PendingIntent.getActivity(context,90,intent_repeating,PendingIntent.FLAG_UPDATE_CURRENT);

        database = FirebaseDatabase.getInstance();
        myRef = database.getReference("menu").child("D2").child(dayOfTheWeek).child("Breakfast");
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                        ...
                        .setContentTitle("Breakfast D2 Menu")
                        .setSound(alarmSound)
