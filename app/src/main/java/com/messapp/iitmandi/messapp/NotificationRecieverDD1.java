...
public class NotificationRecieverDD1 extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        final PendingIntent pendingIntent = PendingIntent.getActivity(context,40,intent_repeating,PendingIntent.FLAG_UPDATE_CURRENT);

        database = FirebaseDatabase.getInstance();
        myRef = database.getReference("menu").child("D1").child(dayOfTheWeek).child("Dinner");
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                        ...
                        .setContentTitle("Dinner D1 Menu")
                        .setSound(alarmSound)
